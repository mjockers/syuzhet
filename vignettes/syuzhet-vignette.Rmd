...
```{r, fig.width = 6}
percent_vals <- get_percentage_values(poa_sent, bins = 20)
plot(
  percent_vals, 
  type="l", 
  main="Joyce's Portrait Using Percentage-Based Means", 
